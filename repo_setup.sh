...
curl --user "$USER:$PASS" --include --request POST --data '{"name":"tech/documentation","color":"5319e7"}' "https://api.github.com/repos/$REPO_USER/$REPO_NAME/labels"
curl --user "$USER:$PASS" --include --request POST --data '{"name":"tech/data science","color":"5319e7"}' "https://api.github.com/repos/$REPO_USER/$REPO_NAME/labels"
